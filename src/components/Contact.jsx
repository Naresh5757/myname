    ...
    <section className="contact section-padding" id="contact">
      <div className="container">
        <div className="section-header">
          ...
          <p className="section-sub">I'm currently open to full-stack developer opportunities. Drop me a message!</p>
        </div>
          ...
          <div className="contact-info">
            ...
            <div className="contact-info-item glass-card">
              ...
              <div>
                ...
                <a href={`tel:${personalInfo.phone}`} className="info-value">{personalInfo.phone}</a>
              </div>
            </div>
            <div className="contact-info-item glass-card">
              <span className="info-icon">📍</span>
            ...
            <div className="contact-social-links">
              <a href={personalInfo.github} target="_blank" rel="noreferrer" className="social-icon-btn">
              ...
              <a href={personalInfo.linkedin} target="_blank" rel="noreferrer" className="social-icon-btn">
      ...
      <footer className="footer">
        <p>Designed & Built by <span className="gradient-text">Begari Naresh</span> · {new Date().getFullYear()}</p>
      </footer>
    </section>
  );
};
